...
% TODO(jullytta): adicionar aqui a mudança do artigo e a nova fórmula %


\section{Conjuntos de Dados}
% Comentar, aqui, sobre não existirem conjuntos de dados de terceiros satisfatórios, não poder existem julgamento
% por fora também. Falar sobre o conjunto de dados que criei.
