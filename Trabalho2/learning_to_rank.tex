...
\section{Conclusões}
A busca personalizada tem muitas limitações: desde a dificuldade em encontrar conjuntos de dados para estudo até a
esparsidade de feedback do usuário. Precisamos de um modelo mais complexo para superar a dificuldade da falta de dados.
